...
import { getUserByEmail, addCommentToPost, addPostToList } from "../../../firebase/store.js"
...
class Post {
    ...
    handleComment = async(post, id) => {
        if(!post.cmtList.includes(id)) {
            ...
            .onSnapshot((snapshot) => {
                snapshot.docChanges().forEach((change) => {
                    ...
                    if (change.type === "added") {
                        ...
                        const cmtEle = new CommemtItem(cmtFb);
                        this.$objCmtItems[change.doc.id]=cmtFb;
                       
                        this.handleComment(post, change.doc.id);
