...
import userInfo from "./inforModal.js"
class body{
    $container;
    $userInforContain;
    $listPost;
    ...
    constructor(){
        ...
        this.$btnCreate.innerHTML = `<img src="https://img.icons8.com/glyph-neue/32/000000/create-new.png"/> Create new post`;

        const userData = JSON.parse(localStorage.getItem("auth-info"));
        this.$userInforContain = new userInfo(userData.email);
